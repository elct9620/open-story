...
module RuboCop::Ext::RegexpParser::Expression::Base
  # source://rubocop/1.40.0/lib/rubocop/ext/regexp_parser.rb#27
  def expression; end

  # source://rubocop/1.40.0/lib/rubocop/ext/regexp_parser.rb#61
  def loc; end

  # source://rubocop/1.40.0/lib/rubocop/ext/regexp_parser.rb#23
  def origin; end
  ...
  # source://rubocop/1.40.0/lib/rubocop/ext/regexp_parser.rb#67
  def build_location; end
end

module RuboCop::Ext::RegexpParser::Expression::CharacterSet
  # source://rubocop/1.40.0/lib/rubocop/ext/regexp_parser.rb#78
  def build_location; end
end
