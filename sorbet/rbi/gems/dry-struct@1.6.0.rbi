...
class Dry::Struct::Constructor < ::Dry::Types::Constructor
  # source://dry-types/1.7.0/lib/dry/types/constructor.rb#16
  def primitive; end
end
...
module Dry::Types
  ...
  class << self
    # source://dry-types/1.7.0/lib/dry/types/constraints.rb#13
    def Rule(options); end

    # source://dry-types/1.7.0/lib/dry/types.rb#115
    def [](name); end

    # source://dry-types/1.7.0/lib/dry/types.rb#163
    def const_missing(const); end

    # source://dry-types/1.7.0/lib/dry/types.rb#82
    def container; end

    # source://dry-types/1.7.0/lib/dry/types.rb#197
    def define_builder(method, &block); end

    # source://dry-types/1.7.0/lib/dry/types.rb#149
    def identifier(klass); end

    # source://dry-types/1.7.0/lib/dry/types.rb#73
    def included(*_arg0); end

    # source://dry-types/1.7.0/lib/dry/types.rb#33
    def loader; end

    # source://dry-core/1.0.0/lib/dry/core/deprecations.rb#202
    def module(*args, &block); end

    # source://dry-types/1.7.0/lib/dry/types.rb#104
    def register(name, type = T.unsafe(nil), &block); end

    # source://dry-types/1.7.0/lib/dry/types.rb#91
    def registered?(class_or_identifier); end

    # source://dry-types/1.7.0/lib/dry/types/constraints.rb#26
    def rule_compiler; end

    # source://dry-types/1.7.0/lib/dry/types.rb#158
    def type_map; end
  end
end

# source://dry-types/1.7.0/lib/dry/types/core.rb#38
Dry::Types::ALL_PRIMITIVES = T.let(T.unsafe(nil), Hash)

# source://dry-types/1.7.0/lib/dry/types/any.rb#45
Dry::Types::Any = T.let(T.unsafe(nil), Dry::Types::AnyClass)

# source://dry-types/1.7.0/lib/dry/types/core.rb#41
...
# source://dry-types/1.7.0/lib/dry/types/inflector.rb#7
Dry::Types::Inflector = T.let(T.unsafe(nil), Dry::Inflector)

# source://dry-types/1.7.0/lib/dry/types/core.rb#6
Dry::Types::KERNEL_COERCIBLE = T.let(T.unsafe(nil), Hash)

# source://dry-types/1.7.0/lib/dry/types/core.rb#16
Dry::Types::METHOD_COERCIBLE = T.let(T.unsafe(nil), Hash)

# source://dry-types/1.7.0/lib/dry/types/core.rb#21
Dry::Types::METHOD_COERCIBLE_METHODS = T.let(T.unsafe(nil), Hash)

# source://dry-types/1.7.0/lib/dry/types/core.rb#26
Dry::Types::NON_COERCIBLE = T.let(T.unsafe(nil), Hash)

# source://dry-types/1.7.0/lib/dry/types/core.rb#44
Dry::Types::NON_NIL = T.let(T.unsafe(nil), Hash)

# source://dry-types/1.7.0/lib/dry/types/printer.rb#296
...
class Dry::Types::Printer
  # source://dry-types/1.7.0/lib/dry/types/printer.rb#38
  def initialize; end

  # source://dry-types/1.7.0/lib/dry/types/printer.rb#43
  def call(type); end

  # source://dry-types/1.7.0/lib/dry/types/printer.rb#49
  def visit(type, &block); end

  # source://dry-types/1.7.0/lib/dry/types/printer.rb#62
  def visit_any(_); end

  # source://dry-types/1.7.0/lib/dry/types/printer.rb#66
  def visit_array(type); end

  # source://dry-types/1.7.0/lib/dry/types/printer.rb#72
  def visit_array_member(array); end

  # source://dry-types/1.7.0/lib/dry/types/printer.rb#155
  def visit_callable(callable); end

  # source://dry-types/1.7.0/lib/dry/types/printer.rb#104
  def visit_composition(composition, &block); end

  # source://dry-types/1.7.0/lib/dry/types/printer.rb#93
  def visit_constrained(constrained); end

  # source://dry-types/1.7.0/lib/dry/types/printer.rb#80
  def visit_constructor(constructor); end

  # source://dry-types/1.7.0/lib/dry/types/printer.rb#129
  def visit_default(default); end

  # source://dry-types/1.7.0/lib/dry/types/printer.rb#110
  def visit_enum(enum); end

  # source://dry-types/1.7.0/lib/dry/types/printer.rb#253
  def visit_hash(hash); end

  # source://dry-types/1.7.0/lib/dry/types/printer.rb#243
  def visit_key(key); end

  # source://dry-types/1.7.0/lib/dry/types/printer.rb#149
  def visit_lax(lax); end

  # source://dry-types/1.7.0/lib/dry/types/printer.rb#229
  def visit_map(map); end

  # source://dry-types/1.7.0/lib/dry/types/printer.rb#143
  def visit_nominal(type); end

  # source://dry-types/1.7.0/lib/dry/types/printer.rb#272
  def visit_options(options, meta = T.unsafe(nil)); end

  # source://dry-types/1.7.0/lib/dry/types/printer.rb#190
