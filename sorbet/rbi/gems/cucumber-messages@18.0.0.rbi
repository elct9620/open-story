...
module Cucumber::Core
  # source://cucumber-core/11.0.0/lib/cucumber/core.rb#20
  def compile(gherkin_documents, last_receiver, filters = T.unsafe(nil), event_bus = T.unsafe(nil)); end

  # source://cucumber-core/11.0.0/lib/cucumber/core.rb#13
  def execute(gherkin_documents, filters = T.unsafe(nil), event_bus = T.unsafe(nil)); end

  private

  # source://cucumber-core/11.0.0/lib/cucumber/core.rb#39
  def compose(filters, last_receiver); end

  # source://cucumber-core/11.0.0/lib/cucumber/core.rb#30
  def parse(gherkin_documents, compiler, event_bus, gherkin_query); end
end

class Cucumber::Core::Compiler
  # source://cucumber-core/11.0.0/lib/cucumber/core/compiler.rb#18
  def initialize(receiver, gherkin_query, event_bus = T.unsafe(nil)); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/compiler.rb#30
  def done; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/compiler.rb#25
  def pickle(pickle); end

  private

  # source://cucumber-core/11.0.0/lib/cucumber/core/compiler.rb#55
  def create_multiline_arg(pickle_step, _uri); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/compiler.rb#37
  def create_test_case(pickle); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/compiler.rb#47
  def create_test_step(pickle_step, uri); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/compiler.rb#15
  ...
  # source://cucumber-core/11.0.0/lib/cucumber/core/compiler.rb#86
  def source_line(id); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/compiler.rb#82
  def source_line_for_pickle_tag(tag); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/compiler.rb#74
  def source_lines_for_pickle(pickle); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/compiler.rb#78
  def source_lines_for_pickle_step(pickle_step); end
end

class Cucumber::Core::Event
  class << self
    # source://cucumber-core/11.0.0/lib/cucumber/core/event.rb#43
    def event_id; end

    # source://cucumber-core/11.0.0/lib/cucumber/core/event.rb#7
    def new(*attributes); end

    private

    # source://cucumber-core/11.0.0/lib/cucumber/core/event.rb#49
    def underscore(string); end
  end
end

class Cucumber::Core::EventBus
  # source://cucumber-core/11.0.0/lib/cucumber/core/event_bus.rb#15
  def initialize(registry = T.unsafe(nil)); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/event_bus.rb#32
  def broadcast(event); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/event_bus.rb#12
  def event_types; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/event_bus.rb#38
  def method_missing(event_id, *args); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/event_bus.rb#23
  def on(event_id, handler_object = T.unsafe(nil), &handler_proc); end

  private

  # source://cucumber-core/11.0.0/lib/cucumber/core/event_bus.rb#45
  def broadcast_queued_events_to(handler, event_type); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/event_bus.rb#53
  def handlers_for(event_class); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/event_bus.rb#57
  def is_registered_id?(event_id); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/event_bus.rb#61
  def is_registered_type?(event_type); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/event_bus.rb#65
  def validate_handler_and_event_id!(handler, event_id); end
end

module Cucumber::Core::Events
  class << self
    # source://cucumber-core/11.0.0/lib/cucumber/core/events.rb#97
    def build_registry(*types); end

    # source://cucumber-core/11.0.0/lib/cucumber/core/events.rb#77
    def registry; end
  end
end

class Cucumber::Core::Events::Envelope < ::Cucumber::Core::Event
  # source://cucumber-core/11.0.0/lib/cucumber/core/events.rb#9
  def envelope; end
end

class Cucumber::Core::Events::GherkinSourceParsed < ::Cucumber::Core::Event
  # source://cucumber-core/11.0.0/lib/cucumber/core/events.rb#15
  def gherkin_document; end
end

class Cucumber::Core::Events::TestCaseCreated < ::Cucumber::Core::Event
  # source://cucumber-core/11.0.0/lib/cucumber/core/events.rb#34
  def pickle; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/events.rb#31
  def test_case; end
end

class Cucumber::Core::Events::TestCaseFinished < ::Cucumber::Core::Event
  # source://cucumber-core/11.0.0/lib/cucumber/core/events.rb#71
  def result; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/events.rb#68
  def test_case; end
end

class Cucumber::Core::Events::TestCaseStarted < ::Cucumber::Core::Event
  # source://cucumber-core/11.0.0/lib/cucumber/core/events.rb#41
  def test_case; end
end

class Cucumber::Core::Events::TestStepCreated < ::Cucumber::Core::Event
  # source://cucumber-core/11.0.0/lib/cucumber/core/events.rb#25
  def pickle_step; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/events.rb#22
  def test_step; end
end

class Cucumber::Core::Events::TestStepFinished < ::Cucumber::Core::Event
  # source://cucumber-core/11.0.0/lib/cucumber/core/events.rb#60
  def result; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/events.rb#57
  def test_step; end
end

class Cucumber::Core::Events::TestStepStarted < ::Cucumber::Core::Event
  # source://cucumber-core/11.0.0/lib/cucumber/core/events.rb#49
  def test_step; end
end

module Cucumber::Core::Filter
  class << self
    # source://cucumber-core/11.0.0/lib/cucumber/core/filter.rb#43
...
class Cucumber::Core::Gherkin::Document
  # source://cucumber-core/11.0.0/lib/cucumber/core/gherkin/document.rb#9
  def initialize(uri, body, language = T.unsafe(nil)); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/gherkin/document.rb#19
  def ==(other); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/gherkin/document.rb#7
  def body; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/gherkin/document.rb#7
  def language; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/gherkin/document.rb#15
  def to_s; end
...
class Cucumber::Core::Gherkin::Parser
  # source://cucumber-core/11.0.0/lib/cucumber/core/gherkin/parser.rb#13
  def initialize(receiver, event_bus, gherkin_query); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/gherkin/parser.rb#19
  def document(document); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/gherkin/parser.rb#45
  def done; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/gherkin/parser.rb#36
  def gherkin_options(document); end

  private

  # source://cucumber-core/11.0.0/lib/cucumber/core/gherkin/parser.rb#10
  def event_bus; end
...
class Cucumber::Core::Report::Summary
  # source://cucumber-core/11.0.0/lib/cucumber/core/report/summary.rb#8
  def initialize(event_bus); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/report/summary.rb#15
  def ok?(be_strict = T.unsafe(nil)); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/report/summary.rb#6
  def test_cases; end
  ...
  # source://cucumber-core/11.0.0/lib/cucumber/core/report/summary.rb#21
...
class Cucumber::Core::Test::Action
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/action.rb#10
  def initialize(location = T.unsafe(nil), &block); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/action.rb#21
  def execute(*args); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/action.rb#35
  def inspect; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/action.rb#31
  def location; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/action.rb#17
  def skip(*_arg0); end

  private

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/action.rb#45
  def failed(exception); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/action.rb#41
  def passed; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/action.rb#49
  def skipped; end
end

class Cucumber::Core::Test::AroundHook
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/around_hook.rb#6
  def initialize(&block); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/around_hook.rb#11
  def describe_to(visitor, *args, &continue); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/around_hook.rb#19
  def execute(*args, &continue); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/around_hook.rb#15
  def hook?; end

  private

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/around_hook.rb#30
  def failed(exception); end
end

class Cucumber::Core::Test::Case
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/case.rb#12
  def initialize(id, name, test_steps, location, tags, language, around_hooks = T.unsafe(nil)); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/case.rb#72
  def ==(other); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/case.rb#10
  def around_hooks; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/case.rb#27
  def describe_to(visitor, *args); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/case.rb#68
  def eql?(other); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/case.rb#64
  def hash; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/case.rb#10
  def id; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/case.rb#60
  def inspect; end
  ...
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/case.rb#54
  def match_locations?(queried_locations); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/case.rb#50
  def match_name?(name_regexp); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/case.rb#46
  def match_tags?(*expressions); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/case.rb#10
  def name; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/case.rb#23
  def step_count; end
  ...
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/case.rb#42
  def with_around_hooks(around_hooks); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/case.rb#38
  def with_steps(test_steps); end

  private

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/case.rb#78
  def compose_around_hooks(visitor, *args, &block); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/case.rb#84
  def match_single_tag_expression?(expression); end
end

class Cucumber::Core::Test::DataTable
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/data_table.rb#31
  def initialize(rows); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/data_table.rb#83
  def ==(other); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/data_table.rb#46
  def data_table?; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/data_table.rb#38
  def describe_to(visitor, *args); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/data_table.rb#50
  def doc_string?; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/data_table.rb#56
  def dup; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/data_table.rb#87
  def inspect; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/data_table.rb#75
  def map(&block); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/data_table.rb#36
  def raw; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/data_table.rb#42
  def to_step_definition_arg; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/data_table.rb#71
  def transpose; end

  private

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/data_table.rb#101
  def ensure_array_of_array(array); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/data_table.rb#105
  def hashes_to_array(hashes); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/data_table.rb#93
  def verify_rows_are_same_length(raw); end
end

class Cucumber::Core::Test::DocString < ::SimpleDelegator
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/doc_string.rb#25
  def initialize(content, content_type); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/doc_string.rb#53
  def ==(other); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/doc_string.rb#23
  def content; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/doc_string.rb#23
  def content_type; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/doc_string.rb#35
  def data_table?; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/doc_string.rb#31
  def describe_to(visitor, *args); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/doc_string.rb#39
  def doc_string?; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/doc_string.rb#63
  def inspect; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/doc_string.rb#43
  def map; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/doc_string.rb#49
  def to_step_definition_arg; end
end

class Cucumber::Core::Test::EmptyMultilineArgument
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/empty_multiline_argument.rb#22
  def all_locations; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/empty_multiline_argument.rb#10
  def data_table?; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/empty_multiline_argument.rb#6
  def describe_to(*_arg0); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/empty_multiline_argument.rb#14
  def doc_string?; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/empty_multiline_argument.rb#26
  def inspect; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/empty_multiline_argument.rb#18
  def map(&block); end
end

module Cucumber::Core::Test::HasLocation
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#158
  def attributes; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#167
  def comments; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#144
  def file; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#140
  def file_colon_line; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#148
  def line; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#152
  def location; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#172
  def multiline_arg; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#162
  def tags; end
end

class Cucumber::Core::Test::HookStep < ::Cucumber::Core::Test::Step
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/step.rb#60
  def initialize(id, text, location, action); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/step.rb#64
  def hook?; end
end
...
module Cucumber::Core::Test::Location
  class << self
    # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#15
    def from_file_colon_line(file_colon_line); end

    # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#20
    def from_source_location(file, line); end

    # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#32
    def new(file, raw_lines = T.unsafe(nil)); end

    # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#11
    def of_caller(additional_depth = T.unsafe(nil)); end
  end
end

class Cucumber::Core::Test::Location::Lines < ::Struct
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#95
  def initialize(raw_data); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#115
  def +(other); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#99
  def first; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#111
  def include?(other); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#127
  def inspect; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#107
  def max; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#103
  def min; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#120
  def to_s; end
  ...
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#133
  def range?; end
end

class Cucumber::Core::Test::Location::Precise < ::Struct
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#74
  def hash; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#56
  def include?(other_lines); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#86
  def inspect; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#60
  def line; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#64
  def match?(other); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#82
  def on_line(new_line); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#70
  def to_s; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#78
  def to_str; end
end

class Cucumber::Core::Test::Location::Wildcard < ::Struct
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#50
  def include?(lines); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#46
  def match?(other); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/location.rb#42
  def to_s; end
end

class Cucumber::Core::Test::LocationsFilter
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/filters/locations_filter.rb#16
  def done; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/filters/locations_filter.rb#11
  def test_case(test_case); end

  private

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/filters/locations_filter.rb#26
  def sorted_test_cases; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/filters/locations_filter.rb#34
  def test_cases; end
end

class Cucumber::Core::Test::NameFilter
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/filters/name_filter.rb#9
  def test_case(test_case); end

  private

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/filters/name_filter.rb#18
  def accept?(test_case); end
end

module Cucumber::Core::Test::Result
  class << self
    # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#13
    def ok?(type, be_strict = T.unsafe(nil)); end

    # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#22
...
class Cucumber::Core::Test::Result::Duration
  ...
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#402
  def initialize(nanoseconds); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#400
  def nanoseconds; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#406
  def to_message_duration; end
end

class Cucumber::Core::Test::Result::Failed
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#108
  def initialize(duration, exception); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#115
  def describe_to(visitor, *args); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#102
  def duration; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#102
  def exception; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#140
  def ok?(be_strict = T.unsafe(nil)); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#126
  def to_message; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#122
  def to_s; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#148
  def with_appended_backtrace(step); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#144
  def with_duration(new_duration); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#153
  def with_filtered_backtrace(filter); end

  class << self
    # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#104
    def ok?(be_strict = T.unsafe(nil)); end
  end
end
...
class Cucumber::Core::Test::Result::Flaky
  class << self
    # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#162
    def ok?(be_strict = T.unsafe(nil)); end
  end
end

class Cucumber::Core::Test::Result::Passed
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#64
  def initialize(duration); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#69
  def describe_to(visitor, *args); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#58
  def duration; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#58
  def duration=(_arg0); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#86
  def ok?(be_strict = T.unsafe(nil)); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#79
  def to_message; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#75
  def to_s; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#90
  def with_appended_backtrace(step); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#94
  def with_filtered_backtrace(filter); end

  class << self
    # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#60
    def ok?(be_strict = T.unsafe(nil)); end
  end
end

class Cucumber::Core::Test::Result::Pending < ::Cucumber::Core::Test::Result::Raisable
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#260
  def describe_to(visitor, *args); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#270
  def to_message; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#266
  def to_s; end

  class << self
    # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#256
    def ok?(be_strict = T.unsafe(nil)); end
  end
end

class Cucumber::Core::Test::Result::Raisable < ::StandardError
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#172
  def initialize(message = T.unsafe(nil), duration = T.unsafe(nil), backtrace = T.unsafe(nil)); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#170
  def duration; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#170
  def message; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#198
  def ok?(be_strict = T.unsafe(nil)); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#186
  def with_appended_backtrace(step); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#182
  def with_duration(new_duration); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#193
  def with_filtered_backtrace(filter); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#178
  def with_message(new_message); end
end

# source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#11
...
class Cucumber::Core::Test::Result::Skipped < ::Cucumber::Core::Test::Result::Raisable
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#235
  def describe_to(visitor, *args); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#245
  def to_message; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#241
  def to_s; end

  class << self
    # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#231
    def ok?(be_strict = T.unsafe(nil)); end
  end
end

class Cucumber::Core::Test::Result::StrictConfiguration
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#284
  def initialize(strict_types = T.unsafe(nil)); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#314
  def merge!(other); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#321
  def set?(type); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#304
  def set_strict(setting, type = T.unsafe(nil)); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#281
  def settings=(_arg0); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#291
...
class Cucumber::Core::Test::Result::Summary
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#339
  def initialize; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#380
  def decrement_failed; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#367
  def duration(duration); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#337
  def durations; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#362
  def exception(exception); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#337
  def exceptions; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#345
  def method_missing(name, *args); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#353
  def ok?(be_strict = T.unsafe(nil)); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#372
  def total(for_status = T.unsafe(nil)); end

  private

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#386
  def get_total(method_name); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#391
  def increment_total(status); end
end

# source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#10
...
class Cucumber::Core::Test::Result::Undefined < ::Cucumber::Core::Test::Result::Raisable
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#210
  def describe_to(visitor, *args); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#220
  def to_message; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#216
  def to_s; end

  class << self
    # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#206
    def ok?(be_strict = T.unsafe(nil)); end
  end
end

class Cucumber::Core::Test::Result::Unknown
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#40
  def describe_to(visitor, *args); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#48
  def to_message; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#44
  def with_filtered_backtrace(filter); end
end
...
class Cucumber::Core::Test::Result::UnknownDuration
  ...
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#425
  def nanoseconds; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#421
  def tap(&block); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/result.rb#429
  def to_message_duration; end
end

class Cucumber::Core::Test::Runner
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#11
  def initialize(event_bus); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#35
  def around_hook(hook, &continue); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#42
  def done; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#15
  def test_case(test_case, &descend); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#26
  def test_step(test_step); end

  private

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#8
  def event_bus; end
...
class Cucumber::Core::Test::Runner::RunningTestCase
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#47
  def initialize; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#89
  def duration(step_duration, step_result); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#85
  def exception(step_exception, step_result); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#52
  def execute(test_step, &continue); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#60
  def failed(step_result); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#65
  def passed(step_result); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#70
  def pending(message, step_result); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#56
  def result; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#75
  def skipped(step_result); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#80
  def undefined(step_result); end

  private

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#93
  def status; end
end
...
class Cucumber::Core::Test::Runner::RunningTestCase::Status::Base
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#101
  def initialize(step_result); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#105
  def execute(test_step, monitor, &continue); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#112
  def result; end

  private

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#98
  def step_result; end
end

class Cucumber::Core::Test::Runner::RunningTestCase::Status::Failing < ::Cucumber::Core::Test::Runner::RunningTestCase::Status::Base
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#130
  def execute(test_step, monitor, &continue); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#139
...
class Cucumber::Core::Test::Runner::RunningTestCase::Status::Passing < ::Cucumber::Core::Test::Runner::RunningTestCase::Status::Base
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#124
  def result(duration); end
end
...
class Cucumber::Core::Test::Runner::RunningTestCase::Status::Skipping < ::Cucumber::Core::Test::Runner::RunningTestCase::Status::Failing
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#147
  def result(duration); end
end

class Cucumber::Core::Test::Runner::RunningTestCase::Status::Unknown < ::Cucumber::Core::Test::Runner::RunningTestCase::Status::Base
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/runner.rb#118
  def result(duration); end
end

class Cucumber::Core::Test::Step
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/step.rb#13
  def initialize(id, text, location, multiline_arg = T.unsafe(nil), action = T.unsafe(nil)); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/step.rb#50
  def action_location; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/step.rb#42
  def backtrace_line; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/step.rb#22
  def describe_to(visitor, *args); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/step.rb#34
  def execute(*args); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/step.rb#26
  def hook?; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/step.rb#11
  def id; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/step.rb#54
  def inspect; end
  ...
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/step.rb#30
  def skip(*args); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/step.rb#11
  def text; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/step.rb#46
  def to_s; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/step.rb#38
...
class Cucumber::Core::Test::Tag
  ...
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/tag.rb#10
  def initialize(location, name); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/tag.rb#15
  def inspect; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/tag.rb#8
  def name; end
end

class Cucumber::Core::Test::TagFilter
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/filters/tag_filter.rb#17
  def done; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/filters/tag_filter.rb#9
  def test_case(test_case); end

  private

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/filters/tag_filter.rb#24
  def test_cases; end
end

class Cucumber::Core::Test::TagFilter::TestCases
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/filters/tag_filter.rb#31
  def initialize; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/filters/tag_filter.rb#35
  def <<(test_case); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/filters/tag_filter.rb#42
  def with_tag_name(tag_name); end

  private

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/filters/tag_filter.rb#29
  def test_cases_by_tag_name; end
end

class Cucumber::Core::Test::Timer
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/timer.rb#13
  def duration; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/timer.rb#17
  def nsec; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/timer.rb#21
  def sec; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/timer.rb#8
  def start; end

  private

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/timer.rb#27
...
module Cucumber::Core::Test::Timer::MonotonicTime
  ...
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/timer.rb#35
  def time_in_nanoseconds; end
...
class Cucumber::Core::Test::UndefinedAction
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/action.rb#63
  def initialize(source_location); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/action.rb#67
  def execute(*_arg0); end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/action.rb#61
  def location; end

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/action.rb#71
  def skip(*_arg0); end

  private

  # source://cucumber-core/11.0.0/lib/cucumber/core/test/action.rb#77
  def undefined; end
end

class Cucumber::Core::Test::UnskippableAction < ::Cucumber::Core::Test::Action
  # source://cucumber-core/11.0.0/lib/cucumber/core/test/action.rb#55
  def skip(*args); end
end
